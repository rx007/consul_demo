...
usage() {
    ...
    echo "Private IP 3 - [REQUIRED] The private IP address of the non bootstrap server."
    echo ""
...
sed -i -- "s/__NON_BOOTSTRAP_PRIVATE_IP2__/$PRIVATE_IP3/g" /root/consul_demo/config.json
